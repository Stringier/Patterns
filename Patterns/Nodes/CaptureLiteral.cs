...
namespace Stringier.Patterns.Nodes {
	...
	internal sealed class CaptureLiteral : Literal {
		...
		internal CaptureLiteral(Capture capture) : base(Case.NoPreference) => CapStore = capture;
		...
		internal CaptureLiteral(Capture capture, Case comparisonType) : base(comparisonType) => CapStore = capture;
